...
# cat.formatted <- unitestsCat(fac.dat, fac.var, fac.label, by1, digits = digits, p.digits = p.digits, simulate.p.value = simulate.p.value, B=B, ShowTotal = ShowTotal, showMissing = Missing)$formatted
...
# final <- unitestsCat(fac.dat, fac.var, fac.label, by1, digits = digits, p.digits = p.digits, simulate.p.value = simulate.p.value, B=B, ShowTotal = ShowTotal, showMissing = Missing)$formatted
#}
